...
impl MutationRoot {
    ...
    async fn create_engagement(
        ...
        Ok(Engagement {
            ...
            shooter_position: Coordinates {
                ...
                heading_deg: input.shooter_position.heading_deg,
                speed_mps: input.shooter_position.speed_mps,
            },
    ...
    async fn update_drone_state(
        ...
        Ok(Drone {
            ...
            fuel_remaining_pct: input.fuel_pct.unwrap_or(75.0),
            accuracy_pct: 92.3,
    ...
    async fn record_telemetry(
        ...
        Ok(TelemetrySnapshot {
            ...
            position: Coordinates {
                ...
                heading_deg: input.position.heading_deg,
                speed_mps: input.position.speed_mps,
            },
            fuel_remaining_pct: input.fuel_pct,
            current_waypoint: input.current_waypoint,
            velocity_mps: input.velocity_mps,
            mesh_connectivity: input.mesh_connectivity,
    ...
    async fn create_convoy(&self, _ctx: &Context<'_>, input: CreateConvoyInput) -> Result<Convoy> {
        ...
        Ok(Convoy {
            ...
            aor_radius_km: input.aor_radius_km,
            drone_count: 0,
        ...
        let waypoints: Vec<Waypoint> = input
            ...
            .map(|w| Waypoint {
                ...
                coordinates: Coordinates {
                    ...
                    heading_deg: w.coordinates.heading_deg,
                    speed_mps: 0.0,
                },
